...
public:
  ...
  std::shared_ptr<Dataset> create(std::string utf8_path, int xsize, int ysize,
                                  int bands, int eType,
                                  std::vector<std::string> options);
  std::shared_ptr<Dataset>
  createMultiDimensional(std::string utf8_path,
                         std::vector<std::string> root_group_options,
                         std::vector<std::string> options);
  std::shared_ptr<Dataset> createCopy(std::string utf8_path,
                                      std::shared_ptr<Dataset> src, int strict,
                                      std::vector<std::string> options);
